...
export function buildSystemPrompt(preset: Preset, input: GenerateInput): string {
  return [
    ...
    "- Headlines: 3–12 words. Never more than 15.",
    "- No paragraphs anywhere. Short lines only.",
    ...
    "- Never open a slide with 'In today's world' or similar filler.",
    "",
    "## Inline markup",
    ...
    "Mark at most two spans per slide.",
    "",
